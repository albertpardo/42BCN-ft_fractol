...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/13 14:52:03 by apardo-m          #+#    #+#             */
/*   Updated: 2023/10/13 14:53:22 by apardo-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */


/* Based on 5_frac_movzoom_color_V0.c  */
...
int	main(void)
{
	...
	win = start_newindow(MAX_X, MAX_Y, "Colors SHIP");
	if (win.mlx_ptr != NULL && win.win_ptr != NULL)
	{
		...
		if (img.img != NULL)
		{
			...
			basic_ship(MAX_ITER, winimg.img);

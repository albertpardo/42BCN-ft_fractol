...
/*   Updated: 2023/09/08 09:52:51 by apardo-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	setcolorbrw(int n, const int maxiter)
{
	int	component;
...
int	setcolor(int n, const int maxiter)
{
	...
	int	palete5[6] = {0x002F2F, 0x046380, 0xEFECCA, 0xA7A37E, 0xE6E2AF, BLACK};

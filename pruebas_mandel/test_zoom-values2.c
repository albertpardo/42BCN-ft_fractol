...
int main(void)
{
	...
	data.minre += (m_pos.re - data.minre) / img.zoom;
	data.maxre -= (data.maxre - m_pos.re) / img.zoom;

	data.maxim -= (data.maxim - m_pos.im) / img.zoom; 
//	data.minim -= data.maxim - ((data.maxre-data.minre) * img.height) / img.width;
	data.minim += (m_pos.im - data.minim) / img.zoom; 
